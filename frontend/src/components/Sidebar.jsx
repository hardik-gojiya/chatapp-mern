      ...
      <div className="h-screen w-16 bg-gray-900 text-white flex flex-col items-center p-4 space-y-6 shadow-lg">
        ...
        {islogedin ? (
          <button
            ...
            className="w-10 h-10 flex items-center justify-center bg-red-500 rounded-lg hover:bg-red-600 transition"
          >
            ➡️
          </button>
        ) : (
        ...
        <button
          ...
          className="w-10 h-10 flex items-center justify-center bg-blue-600 rounded-lg hover:bg-blue-700 transition"
        >
          {darkMode ? (
            <svg
