...
function Sidebar({ toggleDarkMode, darkMode, islogedin, handleLogout }) {
  return (
    <div className="h-screen w-64 bg-gray-900 text-white flex flex-col items-start p-6 space-y-6 shadow-lg">
      <h2 className="text-2xl font-bold">Menu</h2>
      <a
        href="/"
        className="text-lg w-full py-2 px-4 rounded-lg hover:bg-blue-500 transition"
      >
        Home
      </a>
      {islogedin ? (
